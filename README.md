# @emiplegiaqmnpm/exercitationem-laboriosam-autem

![CI](https://github.com/emiplegiaqmnpm/exercitationem-laboriosam-autem/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@emiplegiaqmnpm/exercitationem-laboriosam-autem.svg?style=flat)](https://www.npmjs.com/package/@emiplegiaqmnpm/exercitationem-laboriosam-autem)
...
## Install
```sh
npm i @emiplegiaqmnpm/exercitationem-laboriosam-autem
```
...
fastify.register(require('@emiplegiaqmnpm/exercitationem-laboriosam-autem'))
...
**Note** about `data.fields`: `busboy` consumes the multipart in serial order (stream). Therefore, the order of form fields is *VERY IMPORTANT* to how `@emiplegiaqmnpm/exercitationem-laboriosam-autem` can display the fields to you.
...
For security reasons, `@emiplegiaqmnpm/exercitationem-laboriosam-autem` sets the limit for `parts` and `fileSize` being _1000_ and _1048576_ respectively.
...
```js
fastify.register(require('@emiplegiaqmnpm/exercitationem-laboriosam-autem'), { attachFieldsToBody: true })
...
```js
fastify.register(require('@emiplegiaqmnpm/exercitationem-laboriosam-autem'), { attachFieldsToBody: 'keyValues' })
...
fastify.register(require('@emiplegiaqmnpm/exercitationem-laboriosam-autem'), { attachFieldsToBody: true, onFile })
...
fastify.register(require('@emiplegiaqmnpm/exercitationem-laboriosam-autem'), { attachFieldsToBody: 'keyValues', onFile })
...
fastify.register(require('@emiplegiaqmnpm/exercitationem-laboriosam-autem'), opts)
...
If you want to use `@emiplegiaqmnpm/exercitationem-laboriosam-autem` with `@fastify/swagger` and `@fastify/swagger-ui` you must add a new type called `isFile` and use custom instance of validator compiler [Docs](https://fastify.dev/docs/latest/Reference/Validation-and-Serialization/#validator-compiler).
...
const fastify = require('fastify')({
 // ...
  ajv: {
    ...
    plugins: [require('@emiplegiaqmnpm/exercitationem-laboriosam-autem').ajvFilePlugin]
  }
})
